...
**Status:** Active from 2026-09-19 · **Owner:** Anees Ur Rahman · **Applies to:** every
...
## 1. Artefacts every change must produce
...
A change with no schema impact still needs 1, 4 (rollback = how to revert the release)
and 5. Artefacts 2–3 apply only when the database changes.
...
| Readiness Ledger | Open risks, gaps, readiness status | At each milestone, and whenever a risk opens or closes |
...
## 7. Response format for every change

1. The artefacts (ADR, migration, backfill, rollback, changelog entry).
2. A short summary of the approach.
3. Assumptions and open questions.

Concise, auditable, client-ready.
