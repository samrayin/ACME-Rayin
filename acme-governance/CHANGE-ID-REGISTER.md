...
| ADR-0006 | CHG-2026-026 | Gateway tracing into CAIRO: what is written, where, what it costs in retention, and how it is turned off | Claimed — written, Gate A passed, still Proposed — owner chose a candidate mitigation (§11 pre-call hook strip, 4 source-confirmed fields) for the metadata pass-through finding, not yet built or reviewed |
